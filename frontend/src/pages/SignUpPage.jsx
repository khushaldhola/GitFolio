...
const SignUpPage = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
      <div className='w-full bg-glass rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 bg-red-glass'>
        
      <div className='p-6 space-y-4 md:space-y-6 sm:p-8'>
					<h1 className='text-xl font-bold md:text-2xl text-center'>Create Account</h1>
					<button
						type='button'
						className='text-white bg-[#24292F] hover:bg-[#171717]/90 focus:ring-4
					...
					<p className='text-sm font-light text-gray-500'>
						...
						<Link to='/login' className='font-medium text-primary-600 hover:underline text-red-600'>
							Login
						</Link>
					</p>
				</div>
